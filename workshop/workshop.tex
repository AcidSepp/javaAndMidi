...
\begin{document}
	...
	\lstinputlisting[firstline=5]{../src/main/java/de/haw/landshut/music/Main.java}
	Dieser Beispielcode macht folgendes:
	\begin{itemize}
		\item Erzeugung eines Objektes der Klasse "JavaAndMidi".
		Dise gibt Ihnen die Möglichkeit, über den Synthesizer Channel oder Drum Machine MIDI Channel Noten und Percussion abzuspielen.
...
\end{lstlisting}
	...
	\subsection{Loops}
	In Java können mit den Schlüsselwörtern \verb|for| und \verb|while| Schleifen erstellt werden:
\begin{lstlisting}
while (Bedingung) { // tue stuff solange, wie Bedingung erfuellt ist
	// stuff
}
\end{lstlisting}
